...
export const deleteLecture = catchAsyncError(async (req, res, next) => {
  ...
  // filter method loop through all the items of array and returns new array containg the items which satisfy the given condition
...
// watch() for any changes in the coursecollection

courseCollection.watch().on("change", async () => {
